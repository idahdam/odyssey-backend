...
router
  ...
  .get(auth('getDestinations'), validate(destinationValidation.getDestinations), destinationController.getDestinations);

router
  .route('/:destinationId')
  .get(auth('getDestinations'), validate(destinationValidation.getDestination), destinationController.getDestination)
  .patch(
    auth('manageDestinations'),
